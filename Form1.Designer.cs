namespace tajmer
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// tabPage1
			// 
			tabPage1.Controls.Add(taimer67);
			...
			// taimer67
			// 
			taimer67.BackColor = Color.LightSeaGreen;
			taimer67.Font = new Font("Segoe UI", 68F);
			taimer67.Location = new Point(230, 210);
			taimer67.Name = "taimer67";
			taimer67.Size = new Size(271, 121);
			taimer67.TabIndex = 6;
			taimer67.Text = "00.00";
			taimer67.Click += tajmer_Click;
			// 
			// stop
			// 
